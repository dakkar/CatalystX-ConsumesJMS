...
{
  $CatalystX::ConsumesJMS::WithDefault::VERSION = '0.0.1';
}
{
  $CatalystX::ConsumesJMS::WithDefault::DIST = 'CatalystX-ConsumesJMS';
}
use Moose::Role;
...
CatalystX::ConsumesJMS::WithDefault - sub-role of L<CatalystX::ConsumesJMS> that provides
